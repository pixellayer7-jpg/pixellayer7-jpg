...
1. `1`（Landing **v2.1.15**）
2. `project-estimator`（Calculator **v2.7.1**）
...
| **project-estimator** | Bilingual quote calculator v2.7.1 — Rongen links, engagement record, CRM this-browser    | `react` `vite` `portfolio` `i18n` `vitest`          |
